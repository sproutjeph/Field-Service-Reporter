...
fun FieldServiceReporterTheme(
    ...
    val colorScheme = when {
        androidTheme -> if (useDarkTheme) DarkColorScheme else LightColorSCheme
...
//        androidTheme -> if (useDarkTheme) DarkAndroidGradientColors else LightAndroidGradientColors
